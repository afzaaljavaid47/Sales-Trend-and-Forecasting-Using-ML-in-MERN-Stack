    ...
    <div class="registration-form" style={{padding:'70px'}}>
        ...
        <div class="form-group" style={{textAlign:'center',color:'#37517E',paddingBottom:'20px'}}>
            ...
            <div class="form-group">
                <input type="password" class="form-control item" minlength="8" title="Minimum Length should be 8" name="password" placeholder="Password" onChange={(e)=>this.onInputChange(e)} required/>
            </div>
            <div class="form-group">
