    ...
    return (
        ...
        <h2 style={{padding:"0px"}} class="text-center">Customer Information Form</h2>
            ...
            <div class="form-group">
                ...
                <input type="text" value={this.state.fname} pattern='^[a-zA-Z1-9]+$' class="form-control item" name="fname" minLength="3" title="Username Name Should be at least six characters long and not contain ant space" placeholder="User Name" onChange={(e)=>this.onInputChange(e)} required/>
            </div>
            <div class="form-group">
                <label class="form-label">Last Name</label>
                <input type="text" value={this.state.lname} pattern='^[a-zA-Z1-9]+$' class="form-control item" name="lname" minLength="3" title="Username Name Should be at least six characters long and not contain ant space" placeholder="User Name" onChange={(e)=>this.onInputChange(e)} required/>
            </div>
            <div class="form-group">
